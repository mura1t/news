...
class SiteSettings(models.Model):
    ...
    post_detail = models.SmallIntegerField(help_text="Haber detayında sayfa başına düşen karakter sayısı örn:1000",verbose_name="Haber Detay Karakter",default=1000)
